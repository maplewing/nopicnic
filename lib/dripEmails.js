        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            ...
            <td style="width:50%;vertical-align:top;padding-right:10px;">
              ${post.image ? `<a href="${post.link}" style="display:block;margin-bottom:8px;border:0;"><img src="${post.image}" alt="" width="240" style="display:block;width:100%;height:auto;border:0;"></a>` : ""}
      ...
      <tr><td style="border-top:1px solid #e5e5e5;padding-top:28px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            ...
            <td style="width:50%;vertical-align:top;padding-right:10px;">
              ${p.image ? `<a href="${siteUrl}/shop/${p.slug}" style="display:block;margin-bottom:8px;border:0;"><img src="${p.image}" alt="" width="240" style="display:block;width:100%;height:auto;border:0;"></a>` : ""}
